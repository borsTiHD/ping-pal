  ...
  <div class="h-full flex overflow-hidden text-gray-900 dark:text-gray-100">
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl">
        <div class="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-xs sm:gap-x-6 sm:px-6 lg:px-8 lg:shadow-none">
          ...
          <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form class="grid flex-1 grid-cols-1" action="#" method="GET">
              ...
              <Search class="pointer-events-none col-start-1 row-start-1 size-5 self-center text-gray-400" aria-hidden="true" />
            </form>
              ...
              <Menu as="div" class="relative">
                <MenuButton class="-m-1.5 flex items-center p-1.5">
                  ...
                  <span class="hidden lg:flex lg:items-center">
                    ...
                    <ChevronDown class="ml-2 size-5 text-gray-400" aria-hidden="true" />
                  </span>
                </MenuButton>
